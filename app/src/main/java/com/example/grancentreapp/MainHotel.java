        ...
        if (v instanceof Button) {
            ...
            switch (bt.getId()) {
                ...
                case R.id.trucar7:
                    ...
                    break;
                case R.id.web1:
                    enterWeb("https://hotelfondaeuropa.com");
                    break;
                case R.id.web2:
                    enterWeb("https://www.hotelgranollers.com");
                    break;
                case R.id.web3:
                    enterWeb("https://www.hoteliris.com");
                    break;
                case R.id.web4:
                    enterWeb("https://www.hotel-bb.com/es/hotel/barcelona-granollers");
                    break;
                case R.id.web5:
                    enterWeb("https://www.aparthotelateneavalles.com/es/");
                    break;
                case R.id.web6:
                    enterWeb("https://www.hotelh.es");
                    break;
                case R.id.web7:
                    enterWeb("https://www.hotelciutatgranollers.com");
                    break;
            }
            ...
            switch (iv.getId()) {
                case R.id.img_fonda:
                    localitzacio("geo:@41.6082916,2.2868614,17z");
                    break;
                case R.id.img_granollers:
                    localitzacio("geo:@41.594182,2.2812076,16z");
                    break;
                case R.id.img_iris:
                    localitzacio("geo:@41.6012923,2.2880538,17z");
                    break;
                case R.id.img_bib:
                    localitzacio("geo:@41.614031,2.2995126,16z");
                    break;
                case R.id.img_atenea:
                    localitzacio("geo:@41.5975141,2.2864746,16z");
                    break;
                case R.id.img_h:
                    localitzacio("geo:@41.5808675,2.281323,17z");
                    break;
                case R.id.img_ciutat:
                    localitzacio("geo:@41.600791,2.2939303,17z");
                    break;
            }
        }
